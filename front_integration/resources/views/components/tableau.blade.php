...
<table>
    ...
    <tbody>
        ...
        <td>
            ...
            <div class="left">
                <img src="public/images/logo 1.png" class="profile" alt="#">
            </div>
            <div class="right">
        ...
        <td>
            <div class="position_profile">
            <div class="left">
                <img src="Social icon (1).png" class="profile" alt="#">
                </div>
                <div class="right">
                <h5>Rajesh Sharma</h5>
        ...
        <td>
            <div class="position_profile">
            <div class="left">
                <img src="Social icon (2).png" class="profile" alt="#">
                </div>
                <div class="right">
        ...
        <td>
            <div class="position_profile">
            <div class="left">
                <img src="Social icon (3).png" class="profile" alt="#">
                </div>
                <div class="right">
                <h5>Olivia Taylor</h5>
